...
import { detectCollision as detectMatrixCollision, getFullRows } from './matrixUtil.js';
...
const initGame = () => dispatch(gameState.setGameState(gameState.GAME_STATE_INIT));
